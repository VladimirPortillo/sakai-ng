...
import { Atractivos_turisticos } from '../../interfaces/atractivo';
import { AtractivosService } from '../../services/atractivos.service';

@Component({
  selector: 'app-listar-atractivos',
  templateUrl: './listar-atractivos.component.html',
  styleUrls: ['./listar-atractivos.component.scss']
})
export class ListarAtractivosComponent {
